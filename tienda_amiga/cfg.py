...
TIENDA_AMIGA_PATH = Path(resource_filename("tienda_amiga", "/"))
REPO_ROOT = TIENDA_AMIGA_PATH.parent
config = AutoConfig(search_path=REPO_ROOT)

RESOURCES_DIR = TIENDA_AMIGA_PATH / "resources"
DATA_DIR = RESOURCES_DIR / "data"
Path(DATA_DIR).mkdir(parents=True, exist_ok=True)

config = AutoConfig()
PG_CONN_ID = config("POSTGRES_CONN_ID")
